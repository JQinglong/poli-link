...
router.register(r'council_tree', views.CouncilTreeViewSet)
router.register(r'council_news', views.CouncilNewsViewSet)
router.register(r'filter_speech', views.FilterSpeechViewSet)
